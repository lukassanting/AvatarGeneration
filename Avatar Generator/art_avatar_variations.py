...
def generate_variations_from_image(file_name):
    ...
    image_size = input("How large should the images be? e.g. 256x256: ")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        generate_variations_from_image(input("Please provide a .json file to convert: "))
    elif len(sys.argv) > 2:
        generate_variations_from_image(input("Too many arguments provided. Please provide a .json file to convert: "))
    else:
